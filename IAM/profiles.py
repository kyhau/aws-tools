...
@click.command()
@click.option("--export_key", "-e", required=False,
              help="Print the command to export ACCESS KEY. Valid values: The profile name or its index returned"
                   " from running `aws_profiles`.")
@click.option("--export_profile", "-p", required=False,
              help="Print the command to export AWS_PROFILE. Valida values: The profile name or its index returned"
                   " from running `aws_profiles`.")
