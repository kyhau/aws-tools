...
SFN_ARN_BLUE = "arn:aws:states:ap-southeast-2:1231456789012:stateMachine:K-SFN-StateMachine-Blue"
SFN_ARN_GREEN = "arn:aws:states:ap-southeast-2:1231456789012:stateMachine:K-SFN-StateMachine-Green"
EXE_ARN = lambda arn: arn.replace(":stateMachine:", ":execution:")

apig_client = boto3.client("apigateway")


def test_apig_invoke(sfn_arn, lambda_alias):
    print(f"Testing {lambda_alias}...")
    ...
    resp = apig_client.test_invoke_method(
        ...
        resourceId=START_RESOURCE_ID,
        httpMethod="GET",
        stageVariables={"lambdaAlias": lambda_alias},
...
test_apig_invoke(SFN_ARN_BLUE, "blue")

test_apig_invoke(SFN_ARN_GREEN, "green")
